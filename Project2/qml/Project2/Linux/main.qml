...
Rectangle {
    ...
    PCheckbox
    {
        anchors.left:combo_box1.left
        anchors.top:combo_box1.bottom
        anchors.right:combo_box1.right
        checked: false
        id: checkbox_007
        width: 104
        height: 22
    ...
    PCheckbox
    {
        ...
        anchors.left:combobox_id_01.left
        anchors.top:combobox_id_01.bottom
        anchors.right:combobox_id_01.right
        checked: false
        id: checkbox_008
        width: 104
        height: 22
